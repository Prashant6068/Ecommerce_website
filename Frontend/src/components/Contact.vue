          ...
          <form @submit.prevent="postContact()">
            <div class="form-group">
              ...
              >
                ...
                >
                <span v-if="!$v.user.name.minLength" class="text-danger">
                  length should be atleast 2</span
                >
                <span v-if="!$v.user.name.maxLength" class="text-danger">
            ...
            <div class="form-group">
              ...
              <div
                ...
                class="invalid-feedback"
              >
                <span v-if="!$v.user.contact.required" class="text-danger">
                  contact number is required</span
                >
                <span v-if="!$v.user.contact.numeric" class="text-danger">
                  contact number should contain only digits</span
                >
                <span v-if="!$v.user.contact.maxLength" class="text-danger">
