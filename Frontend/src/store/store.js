...
//     },
//     mutations: {
//         displayy(state, payload) {
//             return state.dis = payload.id,
//                 state.emailaddress = payload.userId

//         },
//         ADD_CART(state, id) { state.inCart.push(id) },
...
//     actions: {
//         dis(context, payload) {
//             context.commit('displayy', payload)
//         },
//         addToCart(context, id) { context.commit('ADD_CART', id) },
//         removeItem(context, id) { context.commit('DEL_ITEM', id) },
