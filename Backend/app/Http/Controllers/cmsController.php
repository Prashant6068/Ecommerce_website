...
class cmsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validated) {
            ...
            if ($image->move(public_path('uploads/'), $name)) {
                ...
                if ($data) {
                    return redirect("cms")->with("msg", "Data successfully inserted");
                } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($image) {
            ...
            if ($data) {
                return redirect("cms")->with("msg", "Data successfully updated");
            } else {
                return back()->with("msg", "error");
            }
        }

        return redirect("cms")->with("err", "not uploaded");
    }
    ...
    public function destroy($id)
    {
        ...
        if ($data->delete()) {
            return redirect("cms")->with("err","Data deleted successfully");
        }
    }
}
