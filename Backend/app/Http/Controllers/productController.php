...
class productController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/products')->with('msg',"Data inserted succesfully");
    }
    }
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($data) {
            ...
            return redirect('/products')->with('msg',"Data updated succesfully");
        }
    }
    ...
    public function destroy($id)
    {
        ...
        $product_data->delete();
        return redirect('/products')->with('err',"Data deleted succesfully");
    }
    public function maill()
    {
        $details = user_order::all();
        return view("sendmail", compact("details"));
    }
}
